...
const DISEASES = [
  {
    ...
    treatment: [
      { line: "Этиотропная терапия", detail: "Бензилпенициллин 1–1,5 млн ЕД в/в каждые 6 ч, 7–10 сут (препарат выбора). Альтернатива: доксициклин 100 мг в/в/per os 2 р/сут." },
      { line: "Лёгкие формы", detail: "Доксициклин 100 мг per os 2 р/сут или ампициллин 500–750 мг per os 4 р/сут, 7 сут." },
      { line: "Дезинтоксикация", detail: "Инфузионная терапия кристаллоидами под контролем ЦВД и диуреза; при анурии — ограничение объёма." },
      { line: "Поражение почек", detail: "Контроль электролитов, коррекция гиперкалиемии; при ОПН — гемодиализ по показаниям." },
      { line: "Геморрагический синдром", detail: "Этамзилат, аминокапроновая кислота; при тяжёлой тромбоцитопении — трансфузия тромбомассы." },
      { line: "Мониторинг", detail: "Ежедневный контроль креатинина, билирубина, тромбоцитов, коагулограммы." },
    ],
  },
  {
    id: 2,
    ...
    treatment: [
      { line: "P. falciparum (неосложнённая)", detail: "Артеметер/люмефантрин (Коартем) per os по схеме 3 сут — препарат первой линии (ВОЗ, 2023). Альтернатива: атоваквон/прогуанил." },
      { line: "P. falciparum (тяжёлая)", detail: "Артесунат в/в 2,4 мг/кг в 0, 12, 24 ч, затем 1 р/сут до возможности перорального приёма — золотой стандарт." },
      { line: "P. vivax / ovale", detail: "Хлорохин 25 мг/кг за 3 сут + примахин 0,25 мг/кг/сут 14 сут (деструкция гипнозоитов для предотвращения рецидивов). Исключить дефицит Г6ФД." },
      { line: "Церебральная малярия", detail: "Артесунат в/в + дексаметазон противопоказан (увеличивает летальность). Противосудорожная терапия, ИВЛ при необходимости." },
      { line: "Анемия", detail: "Трансфузия эритроцитарной массы при Hb < 70 г/л или клинически значимой анемии." },
      { line: "Мониторинг", detail: "Микроскопия мазка крови через 48–72 ч для оценки паразитемии; контроль глюкозы (риск гипогликемии на хинине)." },
    ],
  },
  {
    id: 3,
    ...
    treatment: [
      { line: "Нейтрализация токсина", detail: "Противостолбнячный иммуноглобулин человека (ПСИЧ) 3000–6000 МЕ в/м однократно как можно раньше. При отсутствии — ПСС 100 000–200 000 МЕ в/м или в/в." },
      { line: "Санация очага", detail: "Хирургическая обработка раны (удаление некрозов, дренирование) — обязательно после введения ПСИЧ." },
      { line: "Антибиотикотерапия", detail: "Метронидазол 500 мг в/в каждые 6 ч, 7–10 сут (препарат выбора). Альтернатива: бензилпенициллин 2–4 млн ЕД в/в каждые 4–6 ч." },
      { line: "Противосудорожная терапия", detail: "Диазепам в/в 0,1–0,3 мг/кг каждые 2–4 ч или непрерывная инфузия; при рефрактерных судорогах — магния сульфат, пропофол, мидазолам." },
      { line: "Дыхательная поддержка", detail: "При спазме дыхательных мышц — ранняя трахеостомия и ИВЛ. Мониторинг SpO₂ непрерывно." },
      { line: "Активная иммунизация", detail: "Одновременно с лечением ввести АС-анатоксин (другой участок тела) — перенесённый столбняк не оставляет иммунитета." },
    ],
  },
  {
    id: 4,
    ...
    treatment: [
      { line: "⚠ Специфического лечения нет", detail: "При развившейся клинической картине бешенство в 100% случаев летально. Все усилия — на постэкспозиционную профилактику." },
      { line: "PEP: обработка раны", detail: "Немедленное промывание раны водой с мылом ≥15 мин, обработка 70% этанолом или раствором йода. Выполняется в первые минуты после укуса." },
      { line: "PEP: антирабический иммуноглобулин", detail: "Антирабический иммуноглобулин (АРИЧ) 20 МЕ/кг: максимальная доза инфильтрируется вокруг раны, остаток — в/м. Вводится однократно в день 0." },
      { line: "PEP: вакцинация", detail: "Антирабическая вакцина (КОКАВ) 1,0 мл в/м в дельтовидную мышцу на 0, 3, 7, 14, 30 сут. При тяжёлых укусах — дополнительно на 90-е сутки." },
      { line: "Паллиативная помощь", detail: "При развившемся бешенстве — симптоматическая седация, обезболивание, обеспечение комфорта пациента и поддержка семьи." },
      { line: "Протокол Милуоки", detail: "Экспериментальный протокол (индуцированная кома + противовирусные) — описаны единичные выжившие, не является стандартом лечения." },
    ],
  },
];
